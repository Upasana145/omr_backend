...
exports.allomrData = async (req, res) => {
  try {
    let sql = `SELECT * FROM save_data`;
...
// GET/api/v1/master/readomrData
// exports.readomrData = async (req, res) => {
//   try {
//     let sql = `SELECT * FROM save_data`;
...
//     if (result && result.length > 0) {
//       // User exits, check passwords
//       resSend(res, true, 200, "Map data", result, null);
//     } else {
//       resSend(res, false, 200, "No Record Found!", result, null);
//     }
//   } catch (error) {
...
exports.readomrData = async (req, res) => {
  ...
  try {
    let sql = `SELECT * FROM save_data where template_name = '${template_name}'`;
